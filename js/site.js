  ...
  const I18N = {
    es: {
      ...
      productos: {
        ...
        items: [
          { name: 'Planta mini de escritorio', price: '9,90 €', summary: 'Planta pequeña de interior en maceta. Ideal para escritorio u oficina con luz indirecta; riego moderado y fácil cuidado.', imgAlt: 'Planta mini de escritorio' },
          { name: 'Planta grande recepción', price: '50 €', summary: 'Planta de gran formato para hall o recepción. Especies resistentes y bien presentadas para dar imagen profesional al espacio.', imgAlt: 'Planta grande de recepción' },
          { name: 'Rosa eterna', price: '55 €', summary: 'Rosa natural estabilizada: conserva su aspecto sin agua ni mantenimiento diario. Presentación en caja o soporte, detalle elegante y duradero.', imgAlt: 'Rosa eterna' },
          { name: 'Centro de mesa', price: '45 €', summary: 'Composición floral para mesa de comedor o reunión. Flores y tonos de temporada, lista para sorprender en cualquier ocasión.', imgAlt: 'Centro de mesa' },
          { name: 'Ramo de flores de temporada', price: '60 €', summary: 'Ramo elaborado con flores del momento y follaje seleccionado. Perfecto como regalo o para alegrar el hogar con color fresco.', imgAlt: 'Ramo de flores de temporada' },
          { name: 'Suscripción "Fresh Monday"', price: '200 €', summary: 'Flores frescas cada lunes en tu empresa u oficina: ramo o composición de temporada con entrega puntual y presentación cuidada.', imgAlt: 'Suscripción Fresh Monday' },
    ...
    ca: {
      ...
      productos: {
        ...
        items: [
          { name: 'Planta mini d\'escriptori', price: '9,90 €', summary: 'Planta petita d’interior amb test. Ideal per a escriptori o oficina amb llum indirecta; reg moderat i cura senzilla.', imgAlt: 'Planta mini d\'escriptori' },
          { name: 'Planta gran de recepció', price: '50 €', summary: 'Planta de gran format per a hall o recepció. Espècies resistents i ben presentades per donar imatge professional a l’espai.', imgAlt: 'Planta gran de recepció' },
          { name: 'Rosa eterna', price: '55 €', summary: 'Rosa natural estabilitzada: conserva l’aspecte sense aigua ni manteniment diari. Presentació en caixa o suport, detall elegant i durable.', imgAlt: 'Rosa eterna' },
          { name: 'Centre de taula', price: '45 €', summary: 'Composició floral per a taula de menjador o reunió. Flors i tons de temporada, llesta per sorprendre en qualsevol ocasió.', imgAlt: 'Centre de taula' },
          { name: 'Ram de flors de temporada', price: '60 €', summary: 'Ram elaborat amb flors del moment i fullatge seleccionat. Perfecte com a regal o per alegrar la llar amb color fresc.', imgAlt: 'Ram de flors de temporada' },
          { name: 'Subscripció «Fresh Monday»', price: '200 €', summary: 'Flors fresques cada dilluns a la teva empresa o oficina: ram o composició de temporada amb lliurament puntual i presentació curada.', imgAlt: 'Subscripció Fresh Monday' },
    ...
    en: {
      ...
      productos: {
        h2: 'Our products',
        items: [
          { name: 'Mini desk plant', price: '€9.90', summary: 'Small potted indoor plant for desks and offices; indirect light and moderate watering, easy day-to-day care.', imgAlt: 'Mini desk plant' },
          { name: 'Large reception plant', price: '€50', summary: 'Large-format plant for lobbies and reception areas — hardy, well-presented varieties for a professional welcome.', imgAlt: 'Large reception plant' },
          { name: 'Eternal rose', price: '€55', summary: 'Stabilised natural rose that keeps its look without daily water or care. Presented in a box or holder — elegant and long-lasting.', imgAlt: 'Eternal rose' },
          { name: 'Table centrepiece', price: '€45', summary: 'Floral arrangement for dining or meeting tables using seasonal blooms and colours, ready for any special moment.', imgAlt: 'Table centrepiece' },
          { name: 'Seasonal flower bouquet', price: '€60', summary: 'Hand-crafted bouquet with flowers of the moment and selected foliage — ideal as a gift or a fresh home accent.', imgAlt: 'Seasonal flower bouquet' },
          { name: '“Fresh Monday” subscription', price: '€200', summary: 'Fresh flowers every Monday at your workplace: bouquet or seasonal arrangement with reliable delivery and neat presentation.', imgAlt: 'Fresh Monday subscription' },
